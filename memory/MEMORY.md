...
- [Workflow: wait for go-ahead](workflow-wait-for-go.md) — answer questions only, don't auto-advance steps
- [promid collaboration model](promid-collaboration-model.md) — Claude writes frontend; user writes backend with Claude guiding
